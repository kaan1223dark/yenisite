...
export interface ApiElmalarElmalar extends Schema.CollectionType {
  collectionName: 'elmalars';
  info: {
    singularName: 'elmalar';
    pluralName: 'elmalars';
    displayName: 'Elmalar';
  };
  options: {
...
export interface ApiUrunUrun extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::urun.urun', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::urun.urun', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::elmalar.elmalar': ApiElmalarElmalar;
